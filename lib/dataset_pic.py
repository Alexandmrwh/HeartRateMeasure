...
# with open('../rrest-syn_csv_raw/rrest-syn001_data.csv', 'rb') as csvfile:
...
# print even_times.shape, ppg[:5000].shape

# plt.title("Clean PPG Signal")
# plt.xlim((0, 10))
# plt.ylim((0.0, 1.5))
# plt.xlabel("Sampling Points")
# plt.plot(even_times, ppg[:5000])
# plt.grid(True)
# plt.legend()
# plt.show()

# with open('../rrest-syn_csv/rrest-syn001_data.csv', 'rb') as csvfile:
# 	reader = csv.reader(csvfile)
# 	ppg_str = [row for row in reader]

# ppg_str = np.array(ppg_str)
# ppg = []
# ppg = ppg_str.astype(np.float)
# ppg = ppg.transpose()
...
# plt.ylim((-4.0, 4.0))
# plt.xlabel("Sampling Points")
# plt.plot(even_times, ppg[:5000, 0])
# plt.grid(True)
# plt.legend()
# plt.show()
...
plt.ylim((-4.0, 4.0))
plt.xlabel("Sampling Points")
plt.plot(tmp_even_times[:5000], tmp_hr[:5000])
plt.grid(True)
plt.legend()
plt.show()
